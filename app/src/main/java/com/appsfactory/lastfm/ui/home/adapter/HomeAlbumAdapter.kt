package com.appsfactory.lastfm.ui.home.adapter
...
import com.appsfactory.lastfm.ui.home.IHomeFragment

class HomeAlbumAdapter(
    private val dataBindingComponent: DataBindingComponent,
    appExecutors: AppExecutors,
    var iHomeFragment: IHomeFragment
    ...
    override fun bind(binding: ItemAlbumBinding, item: Album, position: Int) {
        ...
        binding.root.setOnClickListener {
            iHomeFragment.onAlbumClicked(position, item)
        }
    }
}
